...
#REGISTROS PARA TABLA "SUBCONTRATISTAS"------------
DROP TABLE subcontractor_registration;
DROP TRIGGER IF EXISTS after_insertar_subcontratistas;
DROP TRIGGER IF EXISTS after_actualizar_subcontratistas;
DROP TRIGGER IF EXISTS after_eliminar_subcontratistas;
